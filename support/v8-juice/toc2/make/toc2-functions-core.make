...
# not sort the list.
#toc2.call.remove-dupes-holder :=
#toc2.call.remove-dupes-impl = $(if $(filter $(1),$(toc2.call.remove-dupes-holder)),,\
#			$(eval toc2.call.remove-dupes-holder+=$1))
#toc2.call.remove-dupes = $(strip \
#	$(eval toc2.call.remove-dupes-holder:=)\
#	$(foreach ENTRY,\
#		$(if $1,$1,),\
#		$(call toc2.call.remove-dupes-impl,$(ENTRY)))\
#	$(toc2.call.remove-dupes-holder))
